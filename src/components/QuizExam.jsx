...
// ============================================================
const QUESTIONS_ENDPOINT = "http://localhost:5000/quiz"; // 50 টা MCQ এখান থেকে fetch হবে
const SUBMIT_ENDPOINT = "http://localhost:5000/quiz/submit"; // উত্তর সাবমিট এখানে POST হবে
